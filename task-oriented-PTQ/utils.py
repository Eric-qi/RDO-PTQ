...
def init_lic(args):
    ...
    base_dir = f'./results/{args.arch}/{args.type}/{args.quality}' 
    output_dir = os.path.join(base_dir, 'outputs')
    log_dir = os.path.join(base_dir, 'logs')
    ...
    return config, output_dir, log_dir
...
class Logger:
    ...
    def init(self):
        ...
        self.ms_ssim_loss = AverageMeter('MS-SSIM Loss', ':6.3f')
    ...
    def update(self, i, out_criterion, aux_loss):
        ...
        self.ms_ssim_loss.update(out_criterion['ms_ssim_loss'].item())
    ...
    def print(self):
        logging.info(
            ...
            f' MS-SSIM: {self.ms_ssim_loss.avg:.6f} |'
    ...
    def write(self):
        ...
        self.writer.add_scalar('MS-SSIM loss', self.ms_ssim_loss.avg, self.itr)
    ...
    def write_test(self):
        ...
        writer.add_scalar('[Test] MS-SSIM loss', self.ms_ssim_loss.avg, self.itr)
