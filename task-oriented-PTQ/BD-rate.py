...
r"""
    BD-rate and BD-PSNR computation.
    Based on 
    [1] Calculation of average PSNR differences between RD-curves;
    [2] An excel add-in for computing Bjontegaard metric and its evolution;
    [3] https://github.com/Anserw/Bjontegaard_metric.
