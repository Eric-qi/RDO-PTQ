...
class QuantCodingModel(nn.Module):
    ...
    def quant_module_refactor(self, module: nn.Module, weight_quant_params: dict = {}, act_quant_params: dict = {}):
        ...
        for name, child_module in module.named_children():
            if 'g_a' in name:
                ...
                continue
            elif isinstance(child_module, (nn.Conv2d, nn.ConvTranspose2d, nn.Linear, nn.LayerNorm)):
    ...
    def decompress_split(self, input, shape, *params):
        return self.model.decompress_split(input, shape, *params)
